...
HARDCODED_API_KEY = "sk-proj-00-MHeq9_qCfhxeZRlx0dATZbOT-pKTW5AL3ljjDHl-njUVh6jWAPQSy8tjuTMGh32W34o1L6PphxXaPNhDUOQTuRwvblyfaN_7ic8arr9EVaNYmD-QF0MHdXRSZyA0iQlnmBsS1A"
DEFAULT_PAGE = "1"
DEFAULT_LIMIT = "10"
DEFAULT_TIMEOUT = 30
...
def get_api_key(cli_api_key: Optional[str]) -> str:
    """获取 API 密钥：优先 CLI 参数，其次环境变量，最后硬编码默认值。"""
    key = cli_api_key or os.environ.get("IWENCAI_API_KEY", "") or HARDCODED_API_KEY
    if not key:
